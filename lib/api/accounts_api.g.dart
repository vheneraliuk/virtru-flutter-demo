...
class _AccountsClient extends AccountsClient {
  ...
  @override
  Future<List<AppIdBundleResponse>> _getAppIdBundle(String authHeader) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': authHeader};
    _headers.removeWhere((k, v) => v == null);
    ...
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<AppIdBundleResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) =>
            AppIdBundleResponse.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
